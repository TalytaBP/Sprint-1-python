agenda = [
    {
    "nome": "Gustavo",
    "telefone": "11963370119",
    "email": "gustavoacm06@gmail.com",
    "daltonismo": "normal"
    },
    {
    "nome": "Gustavo",
...
def menu():
    while True:
        ...
        if op_us == "1":
            ...
            daltonicos = quant_dalt(agenda,user_dalt)
            print("a quantidade de daltonicos do tipo {0} é {1}".format(user_dalt, daltonicos))
